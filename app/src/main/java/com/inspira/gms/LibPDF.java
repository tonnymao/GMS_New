...
public class LibPDF {
    ...
    public void createPDF(String data) throws FileNotFoundException, DocumentException
    {
                ...
                if(jsonarray.length() > 0){
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        if(!kodebarangnow.equals(kodebarang))
                        {
                            ...
                            cell = new PdfPCell(new Phrase("Per Tanggal " + LibInspira.getCurrentDate("dd-MM-yyyy"), f));
                            cell.setBorder(Border.noborder);
                            cell.setColspan(11);
                            headertable.addCell(cell);
