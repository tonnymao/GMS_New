...
public class FormDODetailItemListFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(!LibInspira.getShared(global.temppreferences, global.temp.salesorder_type_task, "").equals("approval") &&
            ...
            getActivity().setTitle("Delivery Order - List Item");
        }
        return v;
    }
    ...
    public void onActivityCreated(Bundle bundle){
        ...
        itemadapter = new ItemListAdapter(getActivity(), R.layout.list_item_deliveryorder, new ArrayList<ItemAdapter>());
        itemadapter.clear();
...
//            search();
        ...
        {
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_index, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_nomor, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_nama, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_kode, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_satuan, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_price, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_qty, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_fee, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_disc, "");
            LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_notes, "");
        ...
        {
            if(LibInspira.getShared(global.temppreferences, global.temp.deliveryorder_item, "").equals("")){
    ...
    public void onResume() {
        super.onResume();
        strData = LibInspira.getShared(global.temppreferences, global.temp.deliveryorder_item, "");
    }
            ...
            for(int i=0 ; i < pieces.length ; i++){
                ...
                if(!pieces[i].equals(""))
                {
                    ...
                    try {
                        ...
                        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item, "");
                        strData = "";
                        refreshList();
                    }
                }
...
//            }
        ...
        protected void onPostExecute(String result) {
            ...
            try
            {
                ...
                if(jsonarray.length() > 0){
                    ...
                    if(!tempData.equals(LibInspira.getShared(global.temppreferences, global.temp.deliveryorder_item, "")))
                    {
    ...
    protected void setStrData(String newdata){
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item, newdata);
        strData = newdata;
    }

    protected void setEditData(String index, String nomor, String nama, String kode, String satuan, String qty){
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_index, index);
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_nomor, nomor);
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_nama, nama);
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_kode, kode);
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_satuan, satuan);
        LibInspira.setShared(global.temppreferences, global.temp.deliveryorder_item_qty, qty);
        LibInspira.ReplaceFragment(getActivity().getSupportFragmentManager(), R.id.fragment_container, new FormSalesOrderDetailItemFragment());
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(LibInspira.getShared(global.temppreferences, global.temp.salesorder_type_task, "").equals("approval") ||
                ...
                row.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        setEditData(String.valueOf(
                                finalHolder.adapterItem.getIndex()),
